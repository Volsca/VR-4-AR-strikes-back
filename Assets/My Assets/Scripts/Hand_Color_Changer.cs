...
public class Hand_Color_Changer : MonoBehaviour
{
    ...
    public void OnColorChange()
    {
        ...
        GV._DebugWindow.writeDebugMessage("v : " + (int)value, 0, "Hand_Color_Changer");
        ...
        switch ((int)value)
        {
            case 0:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[0]);
                break;
            case 1:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[1]);
                break;
            case 2:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[2]);
                break;
            case 3:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[3]);
                break;
            case 4:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[4]);
                break;
            case 5:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[5]);
                break;
            case 6:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[6]);
                break;
            case 7:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[7]);
                break;
            case 8:
                GV._HandColor = GV._ListOfHandColors[8];
                GV._DebugWindow.writeDebugMessage("Hand color " + 8, 0, "Hand_Color_Changer");
                GV.l_handFade.ChangeHandColor(GV._ListOfHandColors[8]);
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[8]);
                break;
            case 9:
                ...
                GV.r_handFade.ChangeHandColor(GV._ListOfHandColors[9]);
                break;
            default:
                //GV._HandColor = GV._ListOfHandColors[0];
                break;
